...
const DEVIS_PLANS = {
    "site-vitrine": {
        ...
        unit: "FCFA",
        plans: [
            { id: "basic", label: "Basique", min: 60000, max: 70000, desc: "1 à 3 pages, design simple, formulaire de contact." },
            { id: "standard", label: "Standard", min: 75000, max: 80000, desc: "4 à 6 pages, animations, galerie, responsive avancé." },
            { id: "business", label: "Business", min: 85000, max: 90000, desc: "7+ pages, fonctionnalités avancées, SEO poussé, design premium." },
        ],
    },
    flyers: {
        label: "Flyer",
        unit: "FCFA",
        plans: [{ id: "flyer-complet", label: "Conception complète", min: 2000, max: 2500, desc: "Conception complète d'un flyer professionnel, prêt à imprimer ou publier." }],
    },
    "cartes-mariage": {
        label: "Carte de mariage",
        unit: "FCFA",
        plans: [{ id: "mariage-complet", label: "Conception complète", min: 2000, max: 3000, desc: "Conception complète d'une carte de mariage personnalisée en fonction du design du client." }],
    },
    "cartes-obseques": {
        label: "Carte d'obsèques",
        unit: "FCFA",
        plans: [{ id: "obseques-complet", label: "Conception complète", min: 2000, max: 2500, desc: "Conception complète d'une carte d'obsèques sobre et respectueuse." }],
    },
};
