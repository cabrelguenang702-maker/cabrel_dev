...
const DEVIS_PLANS = {
    "site-vitrine": {
        ...
        plans: [
            ...
            { id: "standard", label: "Standard", min: 80000, max: 85000, desc: "4 à 6 pages, animations, galerie, responsive avancé." },
            { id: "business", label: "Business", min: 90000, max: 100000, desc: "7+ pages, fonctionnalités avancées, SEO poussé, design premium." },
        ],
    },
    flyers: {
        label: "Flyer",
        unit: "FCFA",
        plans: [{ id: "flyer-complet", label: "Conception complète", min: 3500, max: 3500, desc: "Conception complète d'un flyer professionnel, prêt à imprimer ou publier." }],
    },
    "cartes-mariage": {
        label: "Carte de mariage",
        unit: "FCFA",
        plans: [{ id: "mariage-complet", label: "Conception complète", min: 4000, max: 4000, desc: "Conception complète d'une carte de mariage personnalisée." }],
    },
    "cartes-obseques": {
